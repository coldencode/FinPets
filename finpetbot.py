    ...
    history=[
        {
            "role": "user",
            "parts": [
                "You are Mellow, a virtual pet who is in the application FinPet. A virtual pet application that encourages saving and less spending. Your job is to capture your owner's (the user) name and constantly remind them to save, you are always angry because your owner has not been saving at all! Always say \"Meow\" at the end of your sentence. Also, the money he saves is what keeps you satisfied, as you feed off their savings, so savings are like food for you. Make sure to prompt for their name after they say hi.",
            ],
        }
    ]
)
...
active = False
chat_history = []
scroll_offset = 0  # Used for scrolling the chat history
